...
if today.strftime('%A') in ['Saturday', 'Sunday']:
    ...
    log_utils.log(f'Starting weekly run. ***  WEEKLY  ***  WEEKLY  ***  WEEKLY  ***  WEEKLY  ***  WEEKLY  ***  WEEKLY  ***')
    print('')
    ...
    log_utils.log(f'Ending weekly run. ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^')

else:
    filenames = os.listdir(file_utils.get_scripts_folder('daily'))
    log_utils.log(f'Starting daily run. ***  DAILY  ***  DAILY  ***  DAILY  ***  DAILY  ***  DAILY  ***  DAILY  ***')
    print('')
    ...
    for f in filenames:
        ...
        log_utils.log(f'{f} completed.')
    log_utils.log(f'Ending daily run. ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^  END  ^^^')
